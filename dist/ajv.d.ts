...
declare type RequiredInstanceOptions = {
    [K in "strict" | "strictTypes" | "strictTuples" | "code" | "inlineRefs" | "loopRequired" | "loopEnum" | "meta" | "messages" | "addUsedSchema" | "validateSchema" | "validateFormats"]: NonNullable<Options[K]>;
};
